...
public final class OgumaProjectURLConstants {
	...
	public static final String URL_CHECK_DUPLICATED = "/check";
	...
	public static final RequestMatcher URL_INDEX = new AntPathRequestMatcher("/index", RequestMethod.GET.toString());

	public static final RequestMatcher URL_EMPLOYEE_TO_PAGES = new AntPathRequestMatcher(
	...
	public static final RequestMatcher URL_EMPLOYEE_INFOSAVE = new AntPathRequestMatcher(
	...
	public static final RequestMatcher URL_EMPLOYEE_INFOUPD = new AntPathRequestMatcher(
			URL_EMPLOYEE_COMMON.concat(URL_INFO_UPDATE), RequestMethod.PUT.toString());

	public static final RequestMatcher URL_EMPLOYEE_DELETE = new AntPathRequestMatcher(
	...
	public static final RequestMatcher URL_ROLE_TO_PAGES = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_TO_PAGES), RequestMethod.GET.toString());

	public static final RequestMatcher URL_ROLE_PAGINATION = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_PAGINATION), RequestMethod.GET.toString());

	public static final RequestMatcher URL_ROLE_AUTHLIST = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_GET_AUTHLIST), RequestMethod.GET.toString());

	public static final RequestMatcher URL_ROLE_GET_ASSIGNED = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_GET_ASSIGNED), RequestMethod.GET.toString());

	public static final RequestMatcher URL_ROLE_INFOSAVE = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_INFO_SAVE), RequestMethod.POST.toString());

	public static final RequestMatcher URL_ROLE_INFOUPD = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_INFO_UPDATE), RequestMethod.PUT.toString());

	public static final RequestMatcher URL_ROLE_DO_ASSIGNMENT = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_DO_ASSIGNMENT), RequestMethod.PUT.toString());

	public static final RequestMatcher URL_ROLE_DELETE = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_INFO_DELETE), RequestMethod.DELETE.toString());

	public static final RequestMatcher URL_ROLE_CHECK_DELETE = new AntPathRequestMatcher(
			URL_ROLE_COMMON.concat(URL_CHECK_DELETE), RequestMethod.GET.toString());

	public static final RequestMatcher URL_ROLE_CHECK_EDITION = new AntPathRequestMatcher(
	...
	public static final RequestMatcher URL_DISTRICT_INFOUPD = new AntPathRequestMatcher(
			URL_DISTRICT_COMMON.concat(URL_INFO_UPDATE), RequestMethod.PUT.toString());

	public static final RequestMatcher URL_DISTRICT_CHECK_EDITION = new AntPathRequestMatcher(
			URL_DISTRICT_COMMON.concat(URL_CHECK_EDITION), RequestMethod.GET.toString());

	public static final RequestMatcher URL_CITY_PAGIANTION = new AntPathRequestMatcher(
			URL_CITY_COMMON.concat(URL_PAGINATION), RequestMethod.GET.toString());

	public static final RequestMatcher URL_CITY_DISTRICT_LIST = new AntPathRequestMatcher(
			URL_CITY_COMMON.concat(URL_GET_DISTRICTS), RequestMethod.GET.toString());

	public static final RequestMatcher URL_CITY_INFOSAVE = new AntPathRequestMatcher(
			URL_CITY_COMMON.concat(URL_INFO_SAVE), RequestMethod.POST.toString());

	public static final RequestMatcher URL_CITY_INFOUPD = new AntPathRequestMatcher(
			URL_CITY_COMMON.concat(URL_INFO_UPDATE), RequestMethod.PUT.toString());

	public static final RequestMatcher URL_CITY_CHECK_EDITION = new AntPathRequestMatcher(
			URL_CITY_COMMON.concat(URL_CHECK_EDITION), RequestMethod.GET.toString());

	public static final RequestMatcher URL_EMPLOYEE_TO_SIGN_UP = new AntPathRequestMatcher(
			URL_EMPLOYEE_COMMON.concat(URL_TO_SIGN_UP), RequestMethod.GET.toString());

	public static final RequestMatcher URL_EMPLOYEE_TOROKU = new AntPathRequestMatcher(
			URL_EMPLOYEE_COMMON.concat(URL_DO_SIGN_UP), RequestMethod.POST.toString());

	public static final RequestMatcher URL_EMPLOYEE_FORGET_PASSWORD = new AntPathRequestMatcher(
			URL_EMPLOYEE_COMMON.concat(URL_FORGET_PASSWORD), RequestMethod.GET.toString());

	public static final RequestMatcher URL_EMPLOYEE_RESET_PASSWORD = new AntPathRequestMatcher(
			URL_EMPLOYEE_COMMON.concat(URL_RESET_PASSWORD), RequestMethod.POST.toString());

	public static final RequestMatcher URL_EMPLOYEE_TO_LOGIN = new AntPathRequestMatcher(
			URL_EMPLOYEE_COMMON.concat(URL_TO_LOGIN), RequestMethod.GET.toString());

	public static final RequestMatcher URL_EMPLOYEE_DO_LOGIN = new AntPathRequestMatcher(
			URL_EMPLOYEE_COMMON.concat(URL_DO_LOGIN), RequestMethod.POST.toString());

	public static final RequestMatcher URL_EMPLOYEE_LOG_OUT = new AntPathRequestMatcher(
			URL_EMPLOYEE_COMMON.concat(URL_LOG_OUT), RequestMethod.POST.toString());

	public static final RequestMatcher URL_CATEGORY_TO_MAINMENU = new AntPathRequestMatcher(
			URL_CATEGORY_COMMON.concat(URL_TO_MAINMENU), RequestMethod.GET.toString());

	public static final RequestMatcher URL_CATEGORY_MENU_INITIAL = new AntPathRequestMatcher(
			URL_CATEGORY_COMMON.concat(URL_MENU_INITIAL), RequestMethod.GET.toString());

	public static final RequestMatcher URL_CATEGORY_INITIAL = new AntPathRequestMatcher(
			URL_CATEGORY_COMMON.concat(URL_INITIAL), RequestMethod.GET.toString());

	public static final RequestMatcher URL_CATEGORY_TO_DISTRICT_PAGES = new AntPathRequestMatcher(
			URL_CATEGORY_COMMON.concat(URL_TO_DISTRICT_PAGES), RequestMethod.GET.toString());

	public static final RequestMatcher URL_CATEGORY_TO_CITY_PAGES = new AntPathRequestMatcher(
